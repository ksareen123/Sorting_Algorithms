...
template <typename T>
struct CustomComparator_greater {
    static size_t comparisons;
...
template <typename T>
size_t CustomComparator_greater<T>::comparisons = 0;
...
SortingStats benchmark_sort(Sort sorting_algorithm, RandomIter begin, RandomIter end) {
    ...
    CustomComparator<int> comp;
    CustomComparator_greater<int> comp2;

    switch (sorting_algorithm) {
        case Sort::BUBBLE:
        t_start = high_resolution_clock::now();
        sort::bubble(begin, end, comp2);
        t_end = high_resolution_clock::now();
        break;
        case Sort::INSERTION:
        t_start = high_resolution_clock::now();
        sort::insertion(begin, end, comp2);
        t_end = high_resolution_clock::now();
        break;
        case Sort::SELECTION:
        t_start = high_resolution_clock::now();
        sort::selection(begin, end, comp2);
        t_end = high_resolution_clock::now();
        break;
    }
	...
	stats.comparisons = comp2.comparisons;
